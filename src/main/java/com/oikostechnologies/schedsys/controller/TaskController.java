...
public class TaskController {
	...
	@ResponseBody
	public String softDeleteTask(@AuthenticationPrincipal MyUserDetails user, @PathVariable("id") long id) {
		return dailyservice.softDeleteTask(user.getUser(), id);
	}
	...
	@PutMapping("/undocheck/{id}")
	@ResponseBody
	public String undoCheck(@PathVariable("id") long id, @AuthenticationPrincipal MyUserDetails user) {
		return dailyservice.undoTask(user.getUser(), id);
	}
	@PutMapping("/undodelete/{id}")
	@ResponseBody
	public String undoDelete(@PathVariable("id") long id, @AuthenticationPrincipal MyUserDetails user) {
		return dailyservice.undoDelete(user.getUser(), id);
	}
